...
import CH01 from '../assets/PORTFOLIO-CAD-FEA/PORTFOLIO-12/CH-01.png';
import CH02 from '../assets/PORTFOLIO-CAD-FEA/PORTFOLIO-12/CH-02.png';
import CH03 from '../assets/PORTFOLIO-CAD-FEA/PORTFOLIO-12/CH-03.png';
import CH04 from '../assets/PORTFOLIO-CAD-FEA/PORTFOLIO-12/CH-04.png';

export const PortfolioDetail12 = () => {
  const project = {
    title: 'Student F1 Car Chassis Design',
    intro: 'The design focuses on a lightweight, rigid spaceframe structure optimized for strength, manufacturability, and compliance with Formula Student safety standards',
