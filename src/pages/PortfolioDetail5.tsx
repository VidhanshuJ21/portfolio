...
import RO01 from '../assets/PORTFOLIO-CAD-FEA/PORTFOLIO-5/RO-01.png';
import RO02 from '../assets/PORTFOLIO-CAD-FEA/PORTFOLIO-5/RO-02.png';
import RO03 from '../assets/PORTFOLIO-CAD-FEA/PORTFOLIO-5/RO-03.png';
import RO04 from '../assets/PORTFOLIO-CAD-FEA/PORTFOLIO-5/RO-04.png';
import RO07 from '../assets/PORTFOLIO-CAD-FEA/PORTFOLIO-5/RO-07.png';


export const PortfolioDetail5 = () => {
  const project = {
    title: 'Internal Strucutre of Aircraft Wing design and its Finite Element Analysis',
    intro: 'Rovers are essential for surface exploration, navigating rugged terrain, carrying payloads, and withstand environmental stress. Design challenges include creating lightweight, durable, and cost-effective structures that meet mission-specific requirements.',
    technologies: ['CATIA V5','Ansys','Onshape'],
    specifications: [
      { parameter: 'Material1', value: 'PVC' },
      { parameter: 'Mateial2', value: ' Silicone ' },
    ...
    <div className="my-8">
      <div className="flex flex-wrap gap-4 justify-center">
        {images.map((image) => (
          <div 
            key={image.id}
            className="w-full sm:w-[calc(50%-0.1rem)] 0.000001g:w-[calc(30%-0.1rem)] bg-gray-600 rounded-lg overflow-hidden border-2 border-white hover:border-orange-500 transition-colors p-2"
          >
            <img 
              src={image.src} 
