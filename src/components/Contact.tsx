...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="py-16 sm:py-20 md:py-24 lg:py-28 bg-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:jadhavvidhanshu@gmail.com" className="text-white hover:text-orange-500 transition-colors">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+919881441558" className="text-white hover:text-orange-500 transition-colors">
                      +91 9881441558
                    </a>
                  </div>
                </div>
              ...
              {/* Social Links */}
              <div className="mt-10">
                <h4 className="text-sm font-medium text-gray-300 mb-4">Follow Me</h4>
