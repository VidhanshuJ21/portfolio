...
export const Hero = () => {
  return (
		<div
			id="home"
			className="flex items-center justify-between px-16 py-16 pt-32"
		>
			{/* Left Content */}
			<div className="flex-1 max-w-2xl">
				...
				<div className="mt-8">
					<a
						...
						download
						className="border-2 border-gray-600 text-white px-6 py-2 rounded hover:border-orange-500 transition-colors"
					>
						Download Resume
					</a>
				</div>
